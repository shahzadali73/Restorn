      ...
      <div className="main-footer">
        <div className="company">
          ...
          <div className="company-box">
            <a href="" className="about-foo">
              About-Us
            </a>
            <a href="" className="contact-foo">
              Contact Us
            </a>
            <a href="" className="reservartion">
              Resevartion
            </a>

            <a href="" className="pravicy1">
              Pravicy Policy
            </a>
            ...
            <a href="">
              ...
              <div className="social-media">
                <div className="social-box">
                  {" "}
                  <FaTwitter className="logoo" />
                </div>

                <div className="social-box">
                  {" "}
                  <FaFacebook className="logoo" />
                </div>
                <div className="social-box">
                  {" "}
                  <FaYoutube className="logoo" />
                </div>
                <div className="social-box">
                  {" "}
                  <FaLinkedin className="logoo" />
                </div>
              </div>
            </a>
          </div>
